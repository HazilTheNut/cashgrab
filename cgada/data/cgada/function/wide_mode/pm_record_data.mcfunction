...
execute if score @a[tag=t_pm_owner,limit=1,scores={activity_state=20..29}] evl_coin_pickup matches 1.. run function cgada:wide_mode/pmt_increment_data_argloader {func_increment:"cgada:wide_mode/pmt_increment_coins_total"}

# If player died while in gameplay, increment total deaths
execute if score @a[tag=t_pm_owner,limit=1,scores={activity_state=10..29}] evl_death matches 1.. run function cgada:wide_mode/pmt_increment_data_argloader {func_increment:"cgada:wide_mode/pmt_increment_deaths_total"}
