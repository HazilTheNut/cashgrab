# tutorial/sequence/stage_passive/pmt_give_transcript.mcfunction
#
# Context:
...
"{\"italic\":false,\"color\":\"dark_gray\",\"text\":\"\"}",\
"[{\"italic\":false,\"color\":\"white\",\"text\":\"Your current \"},{\"italic\":false,\"color\":\"aqua\",\"text\":\"Passive Ability\"},{\"italic\":false,\"color\":\"white\",\"text\":\" has no effect.\"}]",\
"{\"italic\":false,\"color\":\"dark_gray\",\"text\":\"\"}",\
