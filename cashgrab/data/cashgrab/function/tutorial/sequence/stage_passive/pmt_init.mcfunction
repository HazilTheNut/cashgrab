# tutorial/sequence/stage_passive/pmt_init.mcfunction
#
# Context:
...
scoreboard players set @a[tag=t_pm_owner,limit=1] __tutorial_trainee_progress 4

# Set Tutorial destination
scoreboard players set @a[tag=t_pm_owner,limit=1] dtm_tutorial_dest_idx 5
