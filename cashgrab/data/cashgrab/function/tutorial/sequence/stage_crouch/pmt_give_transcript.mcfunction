...
"[{\"italic\":false,\"color\":\"white\",\"text\":\" by \"},{\"italic\":false,\"color\":\"gold\",\"text\":\"crouching or sneaking\"},{\"italic\":false,\"color\":\"white\",\"text\":\".\"}]",\
"{\"italic\":false,\"color\":\"dark_gray\",\"text\":\"\"}",\
"[{\"italic\":false,\"color\":\"white\",\"text\":\"During the tutorial, \"},{\"italic\":false,\"underlined\":true,\"color\":\"gold\",\"text\":\"you must be holding your weapon to\"}]",\
...
"[{\"italic\":false,\"color\":\"aqua\",\"text\":\" Climbing Energy\"},{\"italic\":false,\"color\":\"white\",\"text\":\", which allows you to climb up walls.\"}]",\
"{\"italic\":false,\"color\":\"dark_gray\",\"text\":\"\"}",\
