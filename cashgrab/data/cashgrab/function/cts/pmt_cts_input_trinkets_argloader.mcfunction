...
execute if score @a[tag=t_pm_owner,limit=1,scores={temp_A=1..}] temp_A < NUM_CTS_TRINKETS_LIST_LEN num run function cashgrab:cts/pmt_cts_input_trinkets with storage cashgrab:cts_trinket_select_args
