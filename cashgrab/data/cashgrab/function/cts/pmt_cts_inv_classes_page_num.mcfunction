# cts/pmt_cts_inv_classes_page_num.mcfunction
#
# Context:
...
$execute if score NUM_CTS_CLASSES_PAGE_IDX_MAX num matches ..0 run function cashgrab:cts/pmt_cts_inv_icon_blank {slot:"$(slot)"}
...
minecraft:item_name="[{\"color\":\"gold\",\"italic\":false,\"text\":\"Page $(classes_page_num)\"}]"\
] $(classes_page_num)
