...
$execute if score @a[tag=t_pm_owner,limit=1] __cts_trinkets_page_idx matches 1.. run item replace entity @a[tag=t_pm_owner,limit=1] $(slot) with minecraft:iron_nugget[\
