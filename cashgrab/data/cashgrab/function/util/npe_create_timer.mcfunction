# util/npe_create_timer.mcfunction
#
# Context:
...
#								when it runs func_npe_start, func_npe_tick, and func_npe_end
...
$summon minecraft:marker ~ ~ ~ {data:{func_npe_tick:"$(func_npe_tick)",func_npe_end:"$(func_npe_end)"},Tags:["t_timer_init"]}
