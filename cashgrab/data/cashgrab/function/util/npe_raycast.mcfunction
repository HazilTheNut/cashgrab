...
$data merge storage cashgrab:rc_args {data:{col_terrain_allowed:"$(col_terrain_allowed)",func_entity_filter:"$(func_entity_filter)",func_step:"$(func_step)",func_end:"$(func_end)",delta_x:0.0f,delta_y:0.0f,delta_z:0.0f}}
