...
#	func_npe_step				: Function to run as the missile every tick
...
$data merge entity @e[tag=t_missile_init,limit=1,sort=nearest] {data:{col_terrain_allowed:"$(col_terrain_allowed)",func_npe_entity_filter:"$(func_npe_entity_filter)",func_npe_step:"$(func_npe_step)",func_npe_end:"$(func_npe_end)",vel_x:0.0f,vel_y:0.0f,vel_z:0.0f,f_speed_mpt:$(f_speed_mpt)f,f_tracking_scalar:$(f_tracking_scalar),func_npe_tracking_filter:"$(func_npe_tracking_filter)",tracking_dyaw:0,tracking_dpitch:0}}
