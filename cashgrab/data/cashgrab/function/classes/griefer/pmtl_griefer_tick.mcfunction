...
execute as @e[type=minecraft:creeper,tag=t_griefer_creeper_stasis,tag=t_creeper_peer] at @s run function cashgrab:classes/griefer/creeper_stasis_func_tick

tag @e remove t_creeper_peer
