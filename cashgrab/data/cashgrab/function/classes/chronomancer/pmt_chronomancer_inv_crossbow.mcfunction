...
# Crossbow is not in stasis and loaded
execute if entity @a[tag=t_pm_owner,limit=1,scores={cv_C=1,cv_D=..0}] run item replace entity @a[tag=t_pm_owner,limit=1] weapon.offhand with minecraft:crossbow[minecraft:unbreakable={},\
...
# Crossbow is not in stasis and unloaded
execute if entity @a[tag=t_pm_owner,limit=1,scores={cv_C=0,cv_D=..0}] run item replace entity @a[tag=t_pm_owner,limit=1] weapon.offhand with minecraft:crossbow[minecraft:unbreakable={},\
minecraft:tooltip_display={hidden_components:["minecraft:unbreakable"]},\
minecraft:custom_name={italic:false,color:"red",text:"Clockwork Crossbow"},\
minecraft:lore=[\
{color:"gray",italic:false,text:"This crossbow automatically"},\
...
# Crossbow is in stasis and loaded
execute if entity @a[tag=t_pm_owner,limit=1,scores={cv_C=1,cv_D=1..}] run item replace entity @a[tag=t_pm_owner,limit=1] weapon.offhand with minecraft:crossbow[minecraft:unbreakable={},\
...
minecraft:enchantments={multishot:1},\
minecraft:charged_projectiles=[{id:"minecraft:arrow",count:1b},{id:"minecraft:arrow",count:1b},{id:"minecraft:arrow",count:1b}]]

# Crossbow is in stasis and unloaded
execute if entity @a[tag=t_pm_owner,limit=1,scores={cv_C=0,cv_D=1..}] run item replace entity @a[tag=t_pm_owner,limit=1] weapon.offhand with minecraft:crossbow[minecraft:unbreakable={},\
minecraft:tooltip_display={hidden_components:["minecraft:unbreakable","minecraft:enchantments"]},\
minecraft:custom_name={italic:false,color:"red",text:"Clockwork Crossbow"},\
minecraft:lore=[\
{color:"gray",italic:false,text:"This crossbow automatically"},\
