...
minecraft:attribute_modifiers=[\
{type:"generic.attack_damage",slot:"mainhand",id:"cashgrab:magiciteshiv_atkdmg",amount:4,operation:"add_value"},\
{type:"generic.attack_speed",slot:"mainhand",id:"cashgrab:magiciteshiv_atkspd",amount:-2,operation:"add_value"}]]
