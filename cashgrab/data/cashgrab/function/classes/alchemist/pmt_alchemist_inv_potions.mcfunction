...
minecraft:custom_name=[{color:"aqua",italic:false,text:"[Use]"},{color:"white",text:" Caustic Fume"}],\
...
minecraft:custom_name=[{color:"aqua",italic:false,text:"[Use]"},{color:"white",text:" Booster Brew"}],\
minecraft:enchantment_glint_override=true,\
minecraft:custom_data={is_alchemist_potion:1},\
