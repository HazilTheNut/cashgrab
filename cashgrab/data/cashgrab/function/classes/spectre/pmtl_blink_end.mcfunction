...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ #cashgrab:nonsolid run particle minecraft:smoke ~ ~-1 ~ 0.5 0.75 0.5 0 10 force
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ #cashgrab:nonsolid run particle minecraft:smoke ~ ~-1 ~ 0.5 0.75 0.5 0 30
execute align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~-1 ~ #cashgrab:nonsolid run tp @a[tag=t_pm_owner,limit=1] ~ ~ ~
execute align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~-1 ~ #cashgrab:nonsolid run particle minecraft:smoke ~ ~ ~ 0.5 0.75 0.5 0 10 force
execute align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~-1 ~ #cashgrab:nonsolid run particle minecraft:smoke ~ ~ ~ 0.5 0.75 0.5 0 30
