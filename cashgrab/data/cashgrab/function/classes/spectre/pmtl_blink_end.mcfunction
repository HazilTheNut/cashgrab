...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ #coinwars:nonsolid run tp @a[tag=t_pm_owner,limit=1] ~ ~-1 ~
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ #coinwars:nonsolid run particle minecraft:smoke ~ ~-1 ~ 0.5 0.75 0.5 0 40
execute align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~-1 ~ #coinwars:nonsolid run tp @a[tag=t_pm_owner,limit=1] ~ ~ ~
