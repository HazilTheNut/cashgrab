...
summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:golden_sword",Count:1b},Tags:["t_boomerang_itemdisp_init","t_no_self_cleanup"],Rotation:[0.0f,90.0f],Enchantments:[{id:"minecraft:knockback",lvl:1}]}
