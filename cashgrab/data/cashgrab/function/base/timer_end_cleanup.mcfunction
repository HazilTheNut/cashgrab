...
$execute if @a[tag=t_timer_owner] at @a[tag=t_timer_owner,limit=1] rotated as @a[tag=t_timer_owner,limit=1] run function $(func_npe_end) {end_reason:0}
$execute unless @a[tag=t_timer_owner] at @e[tag=t_timer_owner,limit=1] rotated as @e[tag=t_timer_owner,limit=1] run function $(func_npe_end) {end_reason:0}
