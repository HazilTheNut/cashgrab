...
execute if entity @s[scores={tmr_anchor_pos=0}] run function cashgrab:base/timer_at_owner

# If anchored at creation position
execute if entity @s[scores={tmr_anchor_pos=1..}] run function cashgrab:base/timer_at_self
