...
scoreboard players remove @s[scores={tmr_anchor_pos=0}] tmr_lifetime_ticks 1
scoreboard players remove @s[scores={tmr_anchor_pos=1,stasis_state=-1..0}] tmr_lifetime_ticks 1
