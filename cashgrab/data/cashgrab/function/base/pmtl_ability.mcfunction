...
execute if entity @a[tag=t_pm_owner,scores={__iev_drop=1..,ability_charges=1..,activity_state=20..29}] run function cashgrab:classes/pmtl_class_use_ability with entity @s data.class_info
