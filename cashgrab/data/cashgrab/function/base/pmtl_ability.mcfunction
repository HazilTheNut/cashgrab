...
scoreboard players operation @a[tag=t_pm_owner,limit=1,scores={__iev_drop=1..,ability_charges=1..,activity_state=20..29}] ability_cd_ms = @a[tag=t_pm_owner,limit=1] ability_cfg_cd_ms
