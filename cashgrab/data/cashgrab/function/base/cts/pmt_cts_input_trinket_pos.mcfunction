...
scoreboard players add @a[tag=t_pm_owner,limit=1] trinket_cfg_pos 1
scoreboard players set @a[tag=t_pm_owner,limit=1,scores={trinket_cfg_pos=2..}] trinket_cfg_pos 0
