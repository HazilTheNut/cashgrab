...
$execute if entity @s[scores={col_terrain=1..}] run function $(func_npe_end) {end_reason:20}
$execute if entity @s[scores={col_terrain=0,col_entity=1..}] run function $(func_npe_end) {end_reason:30}
