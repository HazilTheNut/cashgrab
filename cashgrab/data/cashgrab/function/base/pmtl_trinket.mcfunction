...
execute if entity @a[tag=t_pm_owner,limit=1,scores={ps_selected_hotbar_slot=3}] unless items entity @a[tag=t_pm_owner,limit=1] hotbar.3 * run scoreboard players set @a[tag=t_pm_owner,limit=1] trinket_held 1
