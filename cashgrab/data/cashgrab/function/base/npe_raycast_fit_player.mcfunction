...
$execute if entity @s[tag=t_raycast_player_fit_case_met] align y positioned ~ ~-0.5 ~ run function $(func_npe_end) {end_reason:1}
...
$execute if entity @s[tag=t_raycast_player_fit_case_met] positioned ~ ~-1 ~ align y run function $(func_npe_end) {end_reason:1}
execute if entity @s[tag=t_raycast_player_fit_case_met] run return 1
...
$execute if entity @s[tag=t_raycast_player_fit_case_met] positioned ~ ~ ~ align y run function $(func_npe_end) {end_reason:1}
execute if entity @s[tag=t_raycast_player_fit_case_met] run return 1
...
$execute if entity @s[tag=t_raycast_player_fit_case_met] positioned ~$(delta_x) ~$(delta_y) ~$(delta_z) align y positioned ~ ~0.55 ~ run function $(func_npe_end) {end_reason:1}
execute if entity @s[tag=t_raycast_player_fit_case_met] run return 1
...
$execute if entity @s[tag=t_raycast_player_fit_case_met] positioned ~$(delta_x) ~$(delta_y) ~$(delta_z) positioned ~ ~1 ~ align y positioned ~ ~0.05 ~ run function $(func_npe_end) {end_reason:1}
execute if entity @s[tag=t_raycast_player_fit_case_met] run return 1
