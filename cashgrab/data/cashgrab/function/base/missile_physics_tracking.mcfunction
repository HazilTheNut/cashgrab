...
execute facing entity @e[tag=t_collision_candidate,tag=!t_do_not_track,limit=1,sort=nearest] eyes run function cashgrab:util/pe_calc_facing_vector {magnitude:1.0f}
