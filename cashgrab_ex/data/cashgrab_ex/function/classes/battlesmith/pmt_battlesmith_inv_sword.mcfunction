...
# Tier I (cv_E = 0)
item replace entity @a[tag=t_pm_owner,limit=1,scores={cv_E=0}] hotbar.0 with minecraft:stone_sword[minecraft:unbreakable={},\
...
# Tier II (cv_E = 1)
item replace entity @a[tag=t_pm_owner,limit=1,scores={cv_E=1}] hotbar.0 with minecraft:iron_sword[minecraft:unbreakable={},\
...
# Tier III (cv_E = 2)
item replace entity @a[tag=t_pm_owner,limit=1,scores={cv_E=2}] hotbar.0 with minecraft:diamond_sword[minecraft:unbreakable={},\
...
# Tier IV (cv_E = 3)
item replace entity @a[tag=t_pm_owner,limit=1,scores={cv_E=3}] hotbar.0 with minecraft:diamond_sword[minecraft:unbreakable={},\
