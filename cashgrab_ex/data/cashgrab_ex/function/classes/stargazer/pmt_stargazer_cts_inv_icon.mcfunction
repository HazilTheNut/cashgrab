# classes/stargazer/pmt_stargazer_cts_inv_icon.mcfunction
#
# Context:
...
minecraft:lore=[\
"{\"color\":\"dark_gray\",\"italic\":true,\"text\":\"Channel your mana into\"}",\
"{\"color\":\"dark_gray\",\"italic\":true,\"text\":\" astral spellcasting.\"}",\
]] 1
