...
# vfx / sfx
particle minecraft:dust{color:[1.0,1.0,0.7],scale:1.25} ~ ~ ~ 2 1.25 2 0.5 40 force
particle minecraft:electric_spark ~ ~ ~ 2 1.25 2 0 25
...
tag @e[distance=..5,tag=t_collision_candidate] add t_dmg_trgt
tag @s add t_dmg_by
