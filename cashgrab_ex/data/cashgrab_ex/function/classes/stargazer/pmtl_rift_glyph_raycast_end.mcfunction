...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ #cashgrab:nonsolid run tp @a[tag=t_pm_owner,limit=1] ~ ~-1 ~ ~180 ~
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~-1 ~ #cashgrab:nonsolid run tp @a[tag=t_pm_owner,limit=1] ~ ~ ~ ~180 ~
