...
#execute if entity @a[tag=t_pm_owner,scores={__iev_drop=1..,ability_charges=1..}] run function coinwars:classes/pmtl_use_ability_perclass
...
execute if entity @a[tag=t_pm_owner,scores={__iev_drop=1..}] run function coinwars:base/pmt_inv_refresh
# Consume event
...
execute if entity @a[tag=t_pm_owner,scores={ability_cd_ticks=0..}] run function coinwars:base/pmt_inv_ability_icon_argloader
