...
execute if score DEVELOPER_MODE num matches 0 if score NUM_PLAYERCOUNT_CHANGED num matches 1.. if score NUM_GAMESTATE num matches 1..2 run function coinwars:base/gt_display_coin_score
...
execute if score NUM_GAMESTATE num matches 2 if score RED_TEAM coins >= GOAL coins run function coinwars:end_game
execute if score NUM_GAMESTATE num matches 2 if score BLUE_TEAM coins >= GOAL coins run function coinwars:end_game
