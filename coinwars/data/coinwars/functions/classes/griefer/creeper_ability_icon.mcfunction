...
item replace entity @s[scores={cv_C=1..}] hotbar.1 with minecraft:gray_stained_glass_pane{display:{Name:"{\"italic\":false,\"color\":\"gray\",\"text\":\"Ability on Cooldown\"}"}}

item replace entity @s[scores={cv_C=..0}] hotbar.1 with minecraft:experience_bottle{display:{\
Name:"[{\"color\":\"green\",\"italic\":false,\"text\":\"[Use]\"},{\"color\":\"white\",\"text\":\" Creeper in a Bottle\"}]",\
Lore:[\
