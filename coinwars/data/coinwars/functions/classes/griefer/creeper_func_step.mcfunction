...
execute if entity @s[tag=t_explode] as @e[tag=t_collision_candidate,distance=..4.5] run damage @s 8.0 minecraft:fireball by @e[tag=t_dmg_src,limit=1,sort=nearest] from @s
