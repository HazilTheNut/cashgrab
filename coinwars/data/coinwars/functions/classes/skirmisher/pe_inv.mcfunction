...
# =============================
# Armor
item replace entity @s armor.head with minecraft:leather_helmet[minecraft:unbreakable={show_in_tooltip:false},minecraft:dyed_color=15653548]
...
execute if score @s cv_B matches 0 if score @s cv_A matches 0..1 run function coinwars:classes/skirmisher/pe_inv_swords {\
...
execute if score @s cv_B matches 0 if score @s cv_A matches 2 run function coinwars:classes/skirmisher/pe_inv_swords {\
...
execute if score @s cv_B matches 1 run function coinwars:classes/skirmisher/pe_inv_swords {\
b_cleaving_scimitar_enable:1,s_cleaving_scimitar_slot:"hotbar.0",b_dancing_rapier_enable:0,s_dancing_rapier_slot:"hotbar.0"}
execute if score @s cv_B matches 2 run function coinwars:classes/skirmisher/pe_inv_swords {\
