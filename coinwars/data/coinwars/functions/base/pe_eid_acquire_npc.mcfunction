...
execute if score EID_GLOBAL_COUNTER num matches ..10000 run scoreboard players set EID_GLOBAL_COUNTER num 10000
execute if score EID_GLOBAL_COUNTER num matches 99999.. run scoreboard players set EID_GLOBAL_COUNTER num 10000
