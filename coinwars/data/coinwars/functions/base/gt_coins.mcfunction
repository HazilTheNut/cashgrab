...
execute as @e[tag=t_coin_particles,nbt={OnGround:0b}] at @s run particle minecraft:block{block_state:"minecraft:gold_block"} ~ ~ ~ 0 0 0 0 1
...
effect give @a[scores={__iev_coin_pickup=1..},nbt=!{active_effects:[{id:"minecraft:regeneration"}]}] minecraft:regeneration 7 1 false
