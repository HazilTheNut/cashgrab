...
execute as @e[type=#coinwars:projectile,scores={stasis_state=1..2}] at @s run function coinwars:base/pe_stasis_projectile
execute as @e[type=#coinwars:projectile,scores={stasis_state=-1}] at @s run function coinwars:base/pe_stasis_projectile
