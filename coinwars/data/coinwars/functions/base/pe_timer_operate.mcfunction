...
scoreboard players remove @s tmr_lifetime_ticks 1
...
execute if entity @s[scores={tmr_anchor_pos=0}] run function coinwars:util/pe_eid_find_owner
$execute if entity @s[scores={tmr_anchor_pos=0,tmr_lifetime_ticks=1..}] as @e[scores={eid_compare=0}] at @s run function $(func_step)
$execute if entity @s[scores={tmr_anchor_pos=0,tmr_lifetime_ticks=..0},tag=t_cleanup] as @e[scores={eid_compare=0}] at @s run function $(func_end) {end_reason:0}
$execute if entity @s[scores={tmr_anchor_pos=0,tmr_lifetime_ticks=..0},tag=!t_cleanup] as @e[scores={eid_compare=0}] at @s run function $(func_end) {end_reason:1}
