...
# =============================
# Terrain collision
$execute store result score @s col_terrain run function coinwars:util/pe_col_detect_terrain {delta_x:$(vel_x),delta_y:$(vel_y),delta_z:$(vel_z),col_terrain_allowed:"$(col_terrain_allowed)"}
...
$execute if score @s col_terrain matches 0 store result score @s col_entity positioned ~$(vel_x) ~$(vel_y) ~$(vel_z) run function coinwars:util/pe_col_detect_entity {func_entity_filter:"$(func_entity_filter)"}
