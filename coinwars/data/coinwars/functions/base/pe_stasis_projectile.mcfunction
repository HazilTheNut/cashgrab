...
#
# Context:
#	as: a #coinwars:projectile entity
#	at: the entity
#
...
execute if score @s stasis_state matches 1..2 store result entity @s Pos[0] double 0.001 run scoreboard players get @s stasis_stored_x_pos_mm
