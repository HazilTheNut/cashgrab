...
execute if score @a[tag=t_pm_owner,limit=1] activity_state matches 0 run tellraw @a[tag=t_pm_owner,limit=1] "Setting spawnpoint for lobby"
...
execute if score @a[tag=t_pm_owner,limit=1] activity_state matches 10 run tellraw @a[tag=t_pm_owner,limit=1] "Setting spawnpoint for cts"
