...
execute as @a[tag=t_pm_owner,limit=1] if entity @a[tag=t_marked_target,scores={evl_death=1..}] run function cg_maks:classes/vampire/pmtl_vampire_create_remnant_at_marked_target
