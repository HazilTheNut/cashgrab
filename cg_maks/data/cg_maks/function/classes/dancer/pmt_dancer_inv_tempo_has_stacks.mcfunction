...
[{text:" increased speed.",italic:false,color:"gray"}],\
[{text:"===",italic:false,color:"dark_gray"}],\
[{text:"You have ",italic:false,color:"dark_gray"},{text:"2",italic:false,color:"yellow"},{text:" stack.",italic:false,color:"dark_gray"}]\
]] 2
...
[{text:" increased speed.",italic:false,color:"gray"}],\
[{text:"===",italic:false,color:"dark_gray"}],\
[{text:"You have ",italic:false,color:"dark_gray"},{text:"3",italic:false,color:"yellow"},{text:" stack.",italic:false,color:"dark_gray"}]\
]] 3
